...
export const EVENTS = [
  {
    ...
    description: "On the sacred occasion of Guruji’s birthday, we are blessed with an opportunity to attend a powerful session of Meditation, Pravachan & Divine Blessings with Sadguru Sakshi Shree.",
  ...
  {
    slug: "sunday-event-4-january",
    title: "Navvarsh Dhyan Mahotsav",
    description: "Step into the New Year with clarity, peace, and divine guidance. In this special New Year Meditation Festival, Sakshi Shree will take you through a transformative journey of deep meditation, energy cleansing & intention setting for 2026.",
  ...
  {
    slug: "sunday-event-1-february",
    title: "Vasant Mahotsav",
    description: "Step into the season of Vasant with renewed energy, inner peace, and spiritual awakening. In this sacred Vasant Mahotsav, Sakshi Shree will guide you through a profound experience of meditation, satsang, and divine blessings, helping you cleanse inner blockages and align with joy & clarity.",
  ...
  {
    slug: "sunday-event-1-march",
    title: "Holi Milan Samaroh - Special Satsang & Meditation Program",
    description: "Experience the true essence of the festival through a special session of Satsang and deep Meditation. Immerse yourself in the colors of spirituality, receive Guruji’s blessings, and stay to enjoy the sacred Bhojan Prasad with the community.",
    date: "1st March 2026",
    time: "10:00 AM",
    location: "Siddha Sudarshan Sakshi Dhaam, 9, Avantika, Chiranjeev Vihar, Ghaziabad",
    status: "Completed" as const,
  ...
  {
    slug: "sunday-event-5-april",
    title: "Satsang, Meditation & Problem Resolution",
    description: "Are you carrying the weight of unanswered questions? Step away from the noise of daily life and into a space of profound clarity. Join Sakshi Shree for a transformative session of Satsang and Meditation designed to resolve your deepest life problems.",
    date: "5th April 2026",
    time: "10:00 AM",
    location: "Siddha Sudarshan Sakshi Dhaam, 9, Avantika, Chiranjeev Vihar, Ghaziabad",
  ...
  {
    slug: "sunday-event-3-may",
    title: "Beyond Astrology : Meet Sakshi Shree",
    description: "Feeling stuck or facing challenges? Sakshi Shree reads your past, present and future like an open book and without you speaking even a single word, he writes down the main problems of your life and provides powerful and effective remedies.",
    date: "3rd May 2026",
    time: "10:00 AM",
    location: "Siddha Sudarshan Sakshi Dhaam, 9, Avantika, Chiranjeev Vihar, Ghaziabad",
    status: "Available Now" as const,
