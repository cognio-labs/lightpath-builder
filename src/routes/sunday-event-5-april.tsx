...
export const Route = createFileRoute("/sunday-event-5-april")({
  head: () => ({
    meta: [
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: "48px", alignItems: "center" }}>
            <div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "12px", color: "rgba(255,255,255,0.75)", fontSize: "0.9rem", marginBottom: "32px" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "8px" }}><Calendar size={16} style={{ color: "#D4AF37" }} /> <span>5 April 2026</span></div>
            ...
            <div>
              <img src="https://sciencedivine.org/wp-content/uploads/2023/06/17-2-1024x694.webp" alt="Meditation Class" style={{ width: "100%", height: "auto", borderRadius: "24px", boxShadow: "0 20px 50px rgba(0,0,0,0.3)" }} />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container-page">
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "28px", textAlign: "center" }}>
            {[
              ...
              { val: "120+", label: "Events Organized Globally" },
