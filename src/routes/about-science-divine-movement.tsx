...
export const Route = createFileRoute("/about-science-divine-movement")({
  head: () => ({
    meta: [
      { title: "About Science Divine Movement | Science Divine Foundation" },
      {
        name: "description",
        content:
    ...
    links: [{ rel: "canonical", href: "/about-science-divine-movement" }],
  }),
  component: Page,
});
