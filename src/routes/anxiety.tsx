...
export const Route = createFileRoute("/anxiety")({
  head: () => ({
    meta: [
      { title: "Anxiety — Science Divine Foundation" },
      {
        name: "description",
        content:
          "Beating Anxiety Together: Simple Steps to Calm — articles, videos, and guided practices from Sakshi Shree.",
      },
  ...
  component: () => (
    <SolutionPageLayout
      ...
      intro={`Anxiety clouds clarity and steals presence. Discover breath, meditation, and mindset practices to soothe the nervous system and return to calm.`}
    />
  ),
});
