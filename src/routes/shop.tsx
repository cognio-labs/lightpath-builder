...
export const Route = createFileRoute("/shop")({
  head: () => ({
    meta: [
      { title: "Shop | Science Divine Foundation" },
      {
        name: "description",
        content: "Shop Science Divine Foundation products. Get the Science Divine Diamond Diary and other spiritual tools for conscious living.",
      },
