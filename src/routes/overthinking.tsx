  ...
  head: () => ({
    meta: [
      { title: "Overcome Overthinking | Science Divine Foundation" },
      {
        name: "description",
        content:
          "Overthinking No More: Techniques for Clarity and Calm by Sakshi Shree. Break free from the relentless whirlwind of doubt and reclaim mental peace.",
      },
...
const ARTICLES = [
  {
    title: "Understanding Feminine Energy and 6 Ways to Reclaim it",
    href: "https://sciencedivine.org/feminine-energy/",
    tag: "Energy",
    readTime: "9 min",
    desc: "How reconnecting with intuitive, receptive energy naturally quiets the analytical overdrive of overthinking.",
  },
  {
    ...
    tag: "Mindset",
    readTime: "7 min",
    desc: "Practical daily habits for shifting from catastrophic thinking loops to a solution-oriented, positive mindset.",
  },
  {
    title: "10 Ways to Overcome Negative Thoughts",
    href: "https://sciencedivine.org/stop-negative-thinking/",
    tag: "Negativity",
    readTime: "8 min",
    desc: "Evidence-based spiritual techniques for interrupting negative thought spirals before they gain momentum.",
  },
  {
    title: "What is Spirituality & How to Grow it?",
    href: "https://sciencedivine.org/what-is-spirituality/",
    tag: "Spirituality",
    readTime: "10 min",
    desc: "Understanding how spiritual depth creates the inner spaciousness that makes overthinking simply fall away.",
  },
  {
    title: "What is Consciousness: A Beginner's Guide",
    href: "https://sciencedivine.org/what-is-consciousness/",
    tag: "Consciousness",
    readTime: "8 min",
    desc: "An accessible introduction to the witness state ,  the awareness that watches thoughts without being swept away.",
  },
  {
    ...
    tag: "Mind",
    readTime: "8 min",
    desc: "Understanding why the subconscious mind runs repetitive thought loops ,  and how to reprogram them.",
  },
  {
    title: "What Your Conscious Mind Can Do: Simply Explained",
    href: "https://sciencedivine.org/what-is-conscious-mind/",
    tag: "Awareness",
    readTime: "7 min",
    desc: "Harnessing the directing power of the conscious mind to steer mental energy toward clarity and action.",
  },
  {
    ...
    tag: "Daily Practice",
    readTime: "9 min",
    desc: "A morning-to-evening protocol for maintaining present-moment awareness and preventing thought spiraling.",
  },
  {
    ...
    tag: "Mental Health",
    readTime: "6 min",
    desc: "How daily mental wellness practices directly reduce the cognitive load that triggers overthinking.",
  },
];
...
const VIDEOS = [
  {
    id: "V6N--wsi2PA",
    title: "Overthinking का चक्र कैसे तोड़ें? | #overthinking #meditation #SakshiShree",
    lang: "Hindi",
  },
  {
    id: "K8GXgnAchBY",
    title:
      "रुक जायेगा विचारों का ये तूफ़ान | Stop this train of thoughts | Mental Peace | साक्षी श्री",
    lang: "Hindi",
  },
  {
    id: "zbHTL4AIbjQ",
    title: "How to Always Think Positive? | सकारात्मक दृष्टिकोण | Sakshi Shree",
    lang: "Bilingual",
  },
  {
    id: "qZRAoRzMwmM",
    title: "Heart or Mind, whom to follow | Heart and mind Conflict | Sakshi Shree",
    lang: "English",
  },
  { id: "mnLKvGNvlFc", title: "मन के जाल से मुक्ति मिल जाएगी | Sakshi Shree", lang: "Hindi" },
  {
    id: "H_gHAxWkMzQ",
    title: "Power of thoughtless mind | जीवन में सफल होने के लिए विचार शून्यता",
    lang: "Bilingual",
  },
  {
    id: "ds00dU3dK1U",
    title: "विचार शक्ति से आप हर मनचाही सफलता प्राप्त कर सकते हैं | Sadhguru Sakshi Shree",
    lang: "Hindi",
  },
];
    ...
    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-16">
            <div className="lg:col-span-7 space-y-6">
              ...
              <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-[1.15]">
                Overthinking <span style={{ color: "#4338CA" }}>No More</span>: Clarity &amp; Calm
              </h1>

              <p className="text-base md:text-lg text-gray-600 leading-relaxed max-w-xl">
                Replaying scenarios and imagining worst-case outcomes? Overthinking drains mental
                energy, leaving us exhausted, anxious, and unable to focus. At Science Divine,
                discover techniques to quiet the mind's chatter, find clarity, and nurture inner
                peace through mindfulness and self-awareness.
              </p>
            ...
            {[
              {
                ...
                desc: "Learn to watch your thoughts without being swept away by them.",
                icon: Brain,
              },
              {
                title: "Mind Reprogramming",
                desc: "Reprogram the subconscious habits that run repetitive loops.",
                icon: Compass,
              },
              {
                title: "Present Action",
                desc: "Shift your mental energy from contemplation into conscious action.",
                icon: Flower2,
              },
              {
                title: "Daily Protocol",
                desc: "A structured routine to maintain awareness and prevent spirals.",
                icon: Sun,
              },
            ].map((card, idx) => {
          ...
          {tab === "articles" && (
            <div>
              <SectionHeading
                ...
                title="Articles on Quieting the Mind"
                subtitle="Guidance from Sakshi Shree to break free from overthinking and find lasting mental clarity."
              />
              <div
                style={{
                  display: "grid",
                ...
                {ARTICLES.map((a, i) => (
                  <a
                    ...
                    onMouseEnter={(e) => {
                      ...
                      el.style.boxShadow = "0 16px 40px rgba(16,185,129,0.12)";
          ...
          {tab === "quotes" && (
            <div>
              <SectionHeading
                ...
                subtitle="Sacred wisdom from Sakshi Shree to anchor you in stillness and clarity."
              />
              <div
                style={{
                  display: "grid",
                ...
                {QUOTES.map((src, i) => (
                  <div
                    ...
                    onMouseEnter={(e) => {
                      ...
                      el.style.boxShadow = "0 16px 40px rgba(16,185,129,0.18)";
                    }}
                    onMouseLeave={(e) => {
                      const el = e.currentTarget as HTMLElement;
          ...
          {tab === "videos" && (
            <div>
              <SectionHeading
                ...
                title="Video Teachings on Overthinking"
                subtitle="7 powerful sessions from Sakshi Shree on silencing the mental noise and reclaiming clarity."
              />
              <div
                style={{
                  display: "grid",
          ...
          {tab === "podcasts" && (
            <div>
              <SectionHeading
                ...
                title="Testimonials ,  From Chaos to Calm"
                subtitle="Real people sharing how Sakshi Shree's teachings stopped the overthinking spiral."
              />
              <div
                style={{
                  display: "grid",
                ...
                {TESTIMONIALS.map((t, i) => (
                  <div
                    ...
                    onMouseEnter={(e) => {
                      const el = e.currentTarget as HTMLElement;
                      el.style.transform = "translateY(-6px)";
                      el.style.boxShadow = "0 20px 50px rgba(16,185,129,0.12)";
                    }}
                    onMouseLeave={(e) => {
                      const el = e.currentTarget as HTMLElement;
                      el.style.transform = "translateY(0)";
      ...
      >
        ...
        >
          ...
          >
            Stop the endless thought spiral. Connect with Sakshi Shree for personalised guidance on
            achieving lasting stillness, focus, and inner peace.
          </p>
