...
export const Route = createFileRoute("/stress")({
  head: () => ({
    meta: [
      { title: "Stress Reduction | Science Divine Foundation" },
      { name: "description", content: "Boost Your Energy and Tackle Tasks Easily with Sakshi Shree ji’s Tips. Simple methods to recharge and navigate stress." },
    ],
  }),
  component: Page,
});
            ...
            <div className="grid md:grid-cols-2 gap-6 animate-fade-in">
              {PODCASTS.map((p, i) => (
                <div key={i} className="card-premium rounded-2xl p-6 bg-white">
                  ...
                  <Link to="/book-session" className="text-sm font-semibold text-amber-600 hover:text-amber-700 inline-flex items-center gap-1">
