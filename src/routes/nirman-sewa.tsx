...
export const Route = createFileRoute("/nirman-sewa")({
  head: () => ({
    meta: [
      { title: "Sakshidham International Vrindavan - Spiritual Retreat & Membership | Science Divine Foundation" },
      { name: "description", content: "Sakshidham International Vrindavan - A Sacred Space for Transformation. Join as a member for personal guidance, grace, and blessings from Sadguru Sakshi Shree." },
      { property: "og:title", content: "Sakshidham International Vrindavan - Spiritual Retreat Center" },
    ],
    links: [{ rel: "canonical", href: "/nirman-sewa" }],
  }),
  component: Page,
});
