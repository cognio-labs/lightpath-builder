  ...
  head: () => ({
    meta: [
      { title: "Courses — Science Divine Foundation" },
      {
        name: "description",
        content:
          "Transformative courses by Sakshi Shree — Design Your Destiny, Mind Power Meditation, Science of Joyful Living, Sanjeevani Kriya.",
      },
  ...
  return (
    <>
      <PageHero
        ...
        title="Explore our transformative courses"
        subtitle="Four foundational programs. Thousands of graduates. One shared journey — toward yourself."
      />
            ...
            <div key={c.slug} className="glass-card rounded-3xl overflow-hidden hover-lift">
              ...
              <div className="p-8">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link
                    to={`/${c.slug}` as string}
                    className="btn-gradient rounded-full px-6 py-2.5 font-semibold text-sm"
                  >
                    Start Course
                  </Link>
                </div>
      ...
      <section className="ethereal-bg text-white section-pad">
        <div className="container-page text-center">
          ...
          <p className="text-white/80 max-w-2xl mx-auto mb-10">
            Real stories from real people whose lives shifted after taking a Science Divine course.
          </p>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            {TESTIMONIAL_VIDEOS.slice(4, 8).map((v) => (
