        ...
        <div className="container-page">
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: "32px" }}>
            {COURSES_DATA.map((c, i) => (
              <div key={i} style={{ background: "#FFFFFF", borderRadius: "24px", overflow: "hidden", border: "1px solid #E2E8F0", boxShadow: "0 10px 30px rgba(0,0,0,0.02)", display: "flex", flexDirection: "column", transition: "transform 0.25s, box-shadow 0.25s" }}
              ...
              >
                <div style={{ position: "relative", paddingTop: "56.25%", overflow: "hidden" }}>
                  <img src={c.image} alt={c.title} style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover" }} />
                ...
                <div style={{ padding: "32px", flex: 1, display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
                  <div>
                    ...
                    <h3 style={{ fontFamily: "'Playfair Display', serif", fontSize: "1.45rem", fontWeight: 700, color: "#0F172A", marginBottom: "4px" }}>{c.title}</h3>
                    <p style={{ color: "#D4AF37", fontSize: "0.85rem", fontWeight: 600, fontStyle: "italic", marginBottom: "16px" }}>{c.tagline}</p>
                    <p style={{ color: "#64748B", fontSize: "0.9rem", lineHeight: 1.65, marginBottom: "24px" }}>{c.desc}</p>
                  </div>
                  <div>
                    ...
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                      ...
                      <Link to={`/${c.slug}` as any} style={{ display: "inline-flex", alignItems: "center", gap: "6px", background: "linear-gradient(135deg, #F59E0B, #D4AF37)", color: "#0F172A", padding: "10px 24px", borderRadius: "100px", fontWeight: 700, fontSize: "0.85rem", textDecoration: "none" }}>
