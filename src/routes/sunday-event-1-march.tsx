...
export const Route = createFileRoute("/sunday-event-1-march")({
  head: () => ({
    meta: [
      { title: "FREE Masterclass: Discover the Power of Meditation | Science Divine Foundation" },
      {
        name: "description",
        content:
          "Join Sakshi Shree for a free masterclass on 1 March 2026 to find peace, clarity and joy. Register now.",
      },
      { property: "og:title", content: "FREE Meditation Masterclass — Science Divine Foundation" },
      { property: "og:url", content: "/sunday-event-1-march" },
    ],
    links: [{ rel: "canonical", href: "/sunday-event-1-march" }],
  }),
  component: Page,
});
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: "48px", alignItems: "center" }}>
            <div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "12px", color: "rgba(255,255,255,0.75)", fontSize: "0.9rem", marginBottom: "32px" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "8px" }}><Calendar size={16} style={{ color: "#D4AF37" }} /> <span>1 March 2026</span></div>
        ...
        <div className="container-page">
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "28px", textAlign: "center" }}>
            {[
              ...
              { val: "100+", label: "Events Organized Globally" },
