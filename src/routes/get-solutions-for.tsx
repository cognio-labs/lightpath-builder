...
export const Route = createFileRoute("/get-solutions-for")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Discover targeted spiritual and mental wellness solutions — stress, anxiety, depression, parenting, addictions, and more." },
...
function Page() {
  return (
    <>
      <PageHero eyebrow="Solutions Hub" title="Find your path forward" subtitle="Whatever you're working through, ancient wisdom has a doorway. Choose your challenge — we'll meet you there." />

      <section className="section-pad">
        <div className="container-page">
          <SectionHeading center eyebrow="Choose Your Challenge" title="What can we help you with?" />
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {SOLUTION_HUB_CARDS.map(card => (
              <Link key={card.title} to={`/${card.slug}` as string} className="group glass-card rounded-2xl overflow-hidden hover-lift">
