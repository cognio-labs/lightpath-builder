...
export const Route = createFileRoute("/har-ghar-shiksha-volunteers")({
  head: () => ({
    meta: [
      { title: "Become a Volunteer | Science Divine Foundation" },
      { name: "description", content: "Join the Har Ghar Shiksha campaign as a volunteer. Teach children, assist in food distribution, or spread mindfulness." },
    ],
  }),
  component: Page,
});
