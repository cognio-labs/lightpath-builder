...
export const Route = createFileRoute("/finding-purpose")({
  head: () => ({
    meta: [
      { title: "Finding Purpose — Science Divine Foundation" },
      {
        name: "description",
        content:
          "Finding Your Purpose: A Journey to Self-Discovery — articles, videos, and guided practices from Sakshi Shree.",
      },
  ...
  component: () => (
    <SolutionPageLayout
      ...
      intro={`Purpose is discovered, not decided. Turn inward and let your true calling emerge.`}
    />
  ),
});
