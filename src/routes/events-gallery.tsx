...
export const Route = createFileRoute("/events-gallery")({
  head: () => ({
    meta: [
      { title: "Events Gallery | Science Divine Foundation" },
      { name: "description", content: "View photos and moments from past retreats, meditation shivirs, and gatherings of Science Divine Foundation." },
    ],
  }),
  component: Page,
});
    ...
    <>
      ...
      <section className="section-pad bg-white">
        <div className="container-page">
          <Link to="/events" className="text-sm font-semibold text-amber-600 hover:text-amber-700 inline-flex items-center gap-1 mb-8">
