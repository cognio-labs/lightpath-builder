...
export const Route = createFileRoute("/terms-conditions")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Terms and conditions of use for Science Divine Foundation." },
    ...
    <>
      ...
      <section className="section-pad">
        <article className="container-page max-w-3xl mx-auto space-y-5 text-sm leading-relaxed text-muted-foreground">
          <p>By accessing or using Science Divine services, you agree to be bound by these Terms.</p>
          ...
          <h2 className="font-display text-xl font-bold text-foreground pt-4">Intellectual Property</h2>
          <p>All content on Science Divine platforms — text, video, audio, images — is the property of Rama Intellectual and Research Pvt Ltd and its licensors.</p>
          <h2 className="font-display text-xl font-bold text-foreground pt-4">Links</h2>
          <p>Our services may contain links to third-party sites. We are not responsible for their content.</p>
          <h2 className="font-display text-xl font-bold text-foreground pt-4">Termination</h2>
          <p>We reserve the right to suspend or terminate access at any time for violations of these Terms.</p>
