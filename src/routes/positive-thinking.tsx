...
export const Route = createFileRoute("/positive-thinking")({
  head: () => ({
    meta: [
      { title: "Positive Thinking — Science Divine Foundation" },
      {
        name: "description",
        content:
          "The Power of Positive Thinking — articles, videos, and guided practices from Sakshi Shree.",
      },
  ...
  component: () => (
    <SolutionPageLayout
      ...
      intro={`The disciplined choice to focus on what serves your highest good.`}
    />
  ),
});
