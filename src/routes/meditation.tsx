...
export const Route = createFileRoute("/meditation")({
  head: () => ({
    meta: [
      { title: "Meditation — Science Divine Foundation" },
      {
        name: "description",
        content:
          "Start Meditating Today: A Guide to Health and Happiness — articles, videos, and guided practices from Sakshi Shree.",
      },
  ...
  component: () => (
    <SolutionPageLayout
      ...
      intro={`Meditation is not escape — it is the direct path to knowing yourself.`}
    />
  ),
});
