...
export const Route = createFileRoute("/parenting")({
  head: () => ({
    meta: [
      { title: "Parenting — Science Divine Foundation" },
      {
        name: "description",
        content:
          "Sakshi Shree's Guide to Parenting Through the Ages — articles, videos, and guided practices from Sakshi Shree.",
      },
  ...
  component: () => (
    <SolutionPageLayout
      ...
      intro={`Raise conscious, resilient children with wisdom rooted in ancient values and modern understanding.`}
    />
  ),
});
