...
export const Route = createFileRoute("/depression")({
  head: () => ({
    meta: [
      { title: "Depression — Science Divine Foundation" },
      {
        name: "description",
        content:
          "Step by Step: Beating Depression — articles, videos, and guided practices from Sakshi Shree.",
      },
  ...
  component: () => (
    <SolutionPageLayout
      ...
      intro={`Depression is not a life sentence. Through consistent practice, guided wisdom, and community, light returns.`}
    />
  ),
});
