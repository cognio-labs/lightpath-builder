...
export const Route = createFileRoute("/cancellation-and-refund-policy")({
  head: () => ({
    meta: [
      { title: "Cancellation and Refund Policy | Science Divine Foundation" },
      {
        name: "description",
        content: "Cancellation and refund policy for Science Divine courses, events, and products.",
      },
      { property: "og:url", content: "/cancellation-and-refund-policy" },
    ],
    links: [{ rel: "canonical", href: "/cancellation-and-refund-policy" }],
  }),
  component: () => (
    <>
