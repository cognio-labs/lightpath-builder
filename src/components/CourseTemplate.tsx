...
export function CourseTemplate({
  ...
  return (
    <>
      <PageHero
        eyebrow={`Course · ${course.level} · ${course.duration}`}
        title={course.title}
      ...
      <section className="section-pad">
        <div className="container-page grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div
              id="enroll"
              className="glass-card rounded-2xl p-6 flex items-center justify-between flex-wrap gap-4"
            >
              <div>
              ...
              <button className="btn-gradient rounded-full px-7 py-3 font-semibold text-sm">
                Enroll Now
              </button>
            </div>
          </div>
            ...
            {modules.map((m, i) => (
              <div key={i} className="glass-card rounded-2xl p-6">
                <div className="flex items-center gap-3 mb-3">
                  <span className="w-10 h-10 rounded-full gradient-bg text-white grid place-items-center font-bold">
                    {i + 1}
                  </span>
      ...
      <section className="ethereal-bg text-white section-pad">
        <div className="container-page">
          <SectionHeading
            ...
            title={<span className="text-white">Graduates speak</span>}
          />
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            {TESTIMONIAL_VIDEOS.slice(8, 12).map((v) => (
