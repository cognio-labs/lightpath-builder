                  ...
                  <div style={{ padding: "20px", flex: 1, display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
                    ...
                    <div>
                      ...
                      <div style={{ display: "flex", gap: "8px" }}>
                        ...
                        <Link href={`/${init.knowMoreSlug}` as any} style={{ flex: 1, textAlign: "center", background: "#FAF9F6", border: "1px solid #D2D6DC", color: "#0F172A", padding: "9px 12px", borderRadius: "100px", fontWeight: 700, fontSize: "0.78rem", textDecoration: "none" }}>
                          Know More
                        </Link>
                      </div>
                    </div>
