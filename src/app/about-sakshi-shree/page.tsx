              ...
              <div key={item.num} className="card-premium rounded-2xl p-8 relative overflow-hidden">
                ...
                <div className="relative">
                  ...
                  {item.external ? (
                    ...
                    <Link href={item.href} className="text-sm font-semibold text-amber-600 hover:text-amber-700 inline-flex items-center gap-1">
      ...
      <section className="py-20" style={{ background: "linear-gradient(135deg, #FFFBF0, #FFF3D0)" }}>
        <div className="container-page text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/book-session" className="btn-gold rounded-full px-8 py-3.5 text-sm font-semibold">
              Book Personal Session
            </Link>
            <Link href="/courses" className="btn-outline-gold rounded-full px-8 py-3.5 text-sm font-semibold">
              Explore Courses
            </Link>
          </div>
        </div>
